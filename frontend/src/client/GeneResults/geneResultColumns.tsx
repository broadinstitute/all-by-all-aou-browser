...
const geneResultsColumns = [
  ...
  },
  {
    ...
    renderForCSV: (row: GeneAssociations) => macCountForCsv(row.mac_case),
  },
  {
    key: 'mac_control',
    ...
    renderForCSV: (row: GeneAssociations) => macCountForCsv(row.mac_control),
  },
  {
    key: 'mac',
    displayId: 'mac_total',
    heading: 'MAC total',
    tooltip: MAC_TOTAL_TOOLTIP,
    minWidth: 90,
    grow: 0,
    render: (row: GeneAssociations) => formatMacCount(row.mac),
    renderForCSV: (row: GeneAssociations) => macCountForCsv(row.mac),
  },
  {
    key: 'total_variants',
