...
// To parse this data:
//
//   import { Convert, GeneAnalysisPrepared } from "./file";
//
//   const geneAnalysisPrepared = Convert.toGeneAnalysisPrepared(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface GeneAnalysisPrepared {
  n_cases: number
  ...
  pval: number
  pval_burden: number | null
  pval_skat: number | null
  BETA: number | null
}
...
export class Convert {
  public static toGeneAnalysisPrepared(json: string): GeneAnalysisPrepared {
    return cast(JSON.parse(json), r('GeneAnalysisPrepared'))
  }

  public static geneAnalysisPreparedToJson(value: GeneAnalysisPrepared): string {
    return JSON.stringify(uncast(value, r('GeneAnalysisPrepared')), null, 2)
  }
}
...
const typeMap: any = {
  GeneAnalysisPrepared: o(
    [
      ...
      { json: 'phenotype_id', js: 'phenotype_id', typ: '' },
      { json: 'path', js: 'path', typ: u(null, '') },
      { json: 'Pvalue', js: 'Pvalue', typ: 3.14 },
      { json: 'Pvalue_Burden', js: 'Pvalue_Burden', typ: u(3.14, null) },
      { json: 'Pvalue_SKAT', js: 'Pvalue_SKAT', typ: u(3.14, null) },
      { json: 'BETA_Burden', js: 'BETA_Burden', typ: u(3.14, null) },
      { json: 'total_variants', js: 'total_variants', typ: 0 },
      { json: 'pval', js: 'pval', typ: 3.14 },
      { json: 'pval_burden', js: 'pval_burden', typ: u(3.14, null) },
      { json: 'pval_skat', js: 'pval_skat', typ: u(3.14, null) },
